...
const rawVersionCode = Number(process.env.NEXT_PUBLIC_ANDROID_APK_VERSION_CODE ?? "16606");
...
export const DEFAULT_ANDROID_APK_RELEASE: AndroidApkRelease = {
  versionName: rawVersionName || "16.6.6",
  versionCode: Number.isFinite(rawVersionCode) && rawVersionCode > 0 ? Math.floor(rawVersionCode) : 16606,
  downloadUrl: rawDownloadUrl || "https://password-vault-ivory.vercel.app/apk/vault-v16.6.6.apk",
  packageName: rawPackageName || DEFAULT_ANDROID_PACKAGE,
  signingKeySha256:
    rawSigningKeySha256 ||
    "AA:BB:CC:DD:EE:FF:00:11:22:33:44:55:66:77:88:99:AA:BB:CC:DD:EE:FF:00:11:22:33:44:55:66:77:88:99",
  publishedAt: rawPublishedAt || "2026-04-18",
};
