...
export const pinActionSchema = z.enum(
 ['view_secret', 'copy_secret', 'edit_secret', 'delete_secret', 'open_workspace_folder', 'delete_workspace_file', 'delete_calculator_history', 'delete_account', 'admin_view_vault', 'approve_signup_request', 'delete_signup_request', 'unlock_app', 'delete_workspace_folder'] satisfies [PinAction, ...PinAction[]],
);
