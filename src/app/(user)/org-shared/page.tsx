...
export default function OrgSharedPage() {
 ...
 <h1 className='text-3xl font-semibold leading-tight text-slate-900'>{t('orgShared.title')}</h1>
 <p className='text-sm leading-6 text-slate-500'>{t('orgShared.subtitle')}</p>
 </header>
 ...
 {!loadingPage && items.length === 0 ? <p className='text-center text-sm text-slate-500'>{t('orgShared.empty')}</p> : null}
