...
export default function HomePage() { 
  ...
  return React.createElement('section', { className: 'space-y-3.5 pb-24 pt-2' }, 
    React.createElement(Card, { className: 'rounded-[22px] border-[var(--border-strong)] px-4 py-3.5' }, 
    ...
    React.createElement('div', { className: 'grid grid-cols-2 gap-3' },
      React.createElement(Card, { className: 'rounded-[18px] px-3.5 py-3' }, React.createElement('p', { className: 'text-[14px] leading-5 text-slate-500' }, itemsText), React.createElement('p', { className: 'mt-2 text-[34px] font-semibold leading-[1.05] text-slate-800' }, String(itemCount))), 
      React.createElement(Card, { className: 'rounded-[18px] px-3.5 py-3' }, React.createElement('p', { className: 'text-[14px] leading-5 text-slate-500' }, securityText), React.createElement('p', { className: 'mt-2 text-[34px] font-semibold leading-[1.05] text-slate-800' }, String(securityScore)), React.createElement('p', { className: 'mt-1 text-[14px] leading-5 text-slate-500' }, securityLabel)) 
    ), 
    React.createElement(Card, { className: 'rounded-[18px] px-3.5 py-3' }, React.createElement('p', { className: 'text-[14px] leading-5 text-slate-500' }, stabilityText), React.createElement('p', { className: 'mt-2 text-[36px] font-semibold leading-[1.05] text-slate-800' }, String(stabilityScore) + '/100')) 
  ); 
}
